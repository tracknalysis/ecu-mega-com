...
import net.tracknalysis.ecu.ms.normaliser.curveeditor.CurveColumnLabel;
import net.tracknalysis.ecu.ms.normaliser.curveeditor.CurveDefinition;
import net.tracknalysis.ecu.ms.normaliser.curveeditor.CurveGauge;
import net.tracknalysis.ecu.ms.normaliser.curveeditor.CurveLineLabel;
import net.tracknalysis.ecu.ms.normaliser.curveeditor.CurvePreProcessor;
import net.tracknalysis.ecu.ms.normaliser.curveeditor.CurveTracker;
import net.tracknalysis.ecu.ms.normaliser.curveeditor.CurveXAxis;
import net.tracknalysis.ecu.ms.normaliser.curveeditor.CurveXBins;
import net.tracknalysis.ecu.ms.normaliser.curveeditor.CurveYAxis;
import net.tracknalysis.ecu.ms.normaliser.curveeditor.CurveYBins;
import net.tracknalysis.ecu.ms.normaliser.menu.MenuDefinition;
import net.tracknalysis.ecu.ms.normaliser.menu.MenuPreProcessor;
import net.tracknalysis.ecu.ms.normaliser.menu.MenuTracker;
import net.tracknalysis.ecu.ms.normaliser.menu.SubMenuDefinition;
import net.tracknalysis.ecu.ms.normaliser.tableeditor.GridHeight;
import net.tracknalysis.ecu.ms.normaliser.tableeditor.GridOrient;
import net.tracknalysis.ecu.ms.normaliser.tableeditor.PreProcessor;
import net.tracknalysis.ecu.ms.normaliser.tableeditor.TableDefinition;
import net.tracknalysis.ecu.ms.normaliser.tableeditor.TableTracker;
import net.tracknalysis.ecu.ms.normaliser.tableeditor.UpDownLabel;
import net.tracknalysis.ecu.ms.normaliser.tableeditor.XBins;
import net.tracknalysis.ecu.ms.normaliser.tableeditor.YBins;
import net.tracknalysis.ecu.ms.normaliser.tableeditor.ZBins;
import net.tracknalysis.ecu.ms.normaliser.userdefined.UserDefinedDefinition;
import net.tracknalysis.ecu.ms.normaliser.userdefined.UserDefinedField;
import net.tracknalysis.ecu.ms.normaliser.userdefined.UserDefinedPanel;
import net.tracknalysis.ecu.ms.normaliser.userdefined.UserDefinedPreProcessor;
...
public class Process
{
    ...
    static void processExpr(ECUData ecuData, String line)
    {
        ...
        else if (ochGetCommandM.matches())
        {
            ...
            {
                int[] value = {0};
                och = MSUtils.hexStringToBytes(ecuData.getPageIdentifiers(), och, 0, 0, value, 0);
            }
            else
            {
                och = "'" + och + "'";
