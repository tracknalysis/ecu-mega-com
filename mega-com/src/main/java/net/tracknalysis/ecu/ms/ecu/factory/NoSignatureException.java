...
public class NoSignatureException extends SignatureException {
    ...
    public NoSignatureException(String detailMessage, Throwable throwable) {
        super(detailMessage, throwable);
    }

    public NoSignatureException(String detailMessage) {
        super(detailMessage);
    }

    public NoSignatureException(Throwable throwable) {
        super(throwable);
    }
}
